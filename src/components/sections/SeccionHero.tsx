...
export default function SeccionHero() {
  return (
    <Box bgImg={'imgs/pexels-ana-benet-8243357.jpg'} bgPosition={'center'} bgSize={'cover'} h={'500px'} w={'100%'} >
      ...
      <Container maxW={'6xl'} h={'inherit'} >
        <Center w={'inherit'} h={'inherit'} justifyContent={'start'}>
          <Box w={'800px'} h={'auto'} zIndex={1}>
            <Text fontSize={'6xl'} fontWeight={500} lineHeight={'50px'}>Potenciamos el desarrollo económico Argentino</Text>
            ...
            <Button mt={5} colorScheme='blue' variant={'outline'} size={'lg'}>Contactanos</Button>
          </Box>
        </Center>
      </Container>
    </Box>
